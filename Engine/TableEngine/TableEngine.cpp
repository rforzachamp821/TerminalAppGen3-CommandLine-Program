//
// TableEngine.cpp - File containing the function definitions for the TableEngine class.
//
...
size_t TableEngine::GetColumnSize(std::vector<std::string> vsMembers) {
