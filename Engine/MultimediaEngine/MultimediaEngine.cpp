...
#pragma comment(lib, "Engine/MultimediaEngine/BASS/bass.lib")
#pragma comment(lib, "Engine/MultimediaEngine/BASS/bassflac.lib")
#pragma comment(lib, "Engine/MultimediaEngine/BASS/bassopus.lib")

// RemoveFilters
bool MultimediaEngine::RemoveFilters(IGraphBuilder* pGraph)
{
...
// DShowMultimediaPlayer
bool MultimediaEngine::DShowMultimediaPlayer(std::wstring wsInputFilePath) {
...
// BASSAudioPlayer
bool MultimediaEngine::BASSAudioPlayer(std::string sInputFilePath) {
...
// MMAPIAudioPlayer
bool MultimediaEngine::MMAPIAudioPlayer(std::string sInputFilePath) {
...
// TTSOutput
bool MultimediaEngine::TTSOutput(std::wstring wsText) {
...
// BeepSound
bool MultimediaEngine::BeepSound(long double dFrequency, long double dDuration, bool bExitOnKeyPress) {
	HWAVEOUT hWaveOut;
	WAVEFORMATEX wfx;
